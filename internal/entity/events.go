...
type Event struct {
	...
	AdditionalInformation null.String `boil:"additional_information" json:"additional_information,omitempty" toml:"additional_information" yaml:"additional_information,omitempty"`
	Location              null.String `boil:"location" json:"location,omitempty" toml:"location" yaml:"location,omitempty"`
	RegistrationLink      null.String `boil:"registration_link" json:"registration_link,omitempty" toml:"registration_link" yaml:"registration_link,omitempty"`
...
var EventTableColumns = struct {
	...
	AdditionalInformation: "events.additional_information",
	Location:              "events.location",
	RegistrationLink:      "events.registration_link",
...
var EventWhere = struct {
	...
	AdditionalInformation whereHelpernull_String
	Location              whereHelpernull_String
	RegistrationLink      whereHelpernull_String
	...
	AdditionalInformation: whereHelpernull_String{field: "\"events\".\"additional_information\""},
	Location:              whereHelpernull_String{field: "\"events\".\"location\""},
	RegistrationLink:      whereHelpernull_String{field: "\"events\".\"registration_link\""},
...
type eventR struct {
	EventDays EventDaySlice `boil:"EventDays" json:"EventDays" toml:"EventDays" yaml:"EventDays"`
}
...
func (r *eventR) GetEventDays() EventDaySlice {
	if r == nil {
		return nil
	}
	return r.EventDays
...
var (
	eventAllColumns            = []string{"id", "title", "description", "additional_information", "location", "registration_link", "created_at", "updated_at"}
	eventColumnsWithoutDefault = []string{"title"}
	eventColumnsWithDefault    = []string{"id", "description", "additional_information", "location", "registration_link", "created_at", "updated_at"}
...
// EventDays retrieves all the event_day's EventDays with an executor.
func (o *Event) EventDays(mods ...qm.QueryMod) eventDayQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"event_days\".\"event_id\"=?", o.ID),
	)

	return EventDays(queryMods...)
}

// LoadEventDays allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (eventL) LoadEventDays(ctx context.Context, e boil.ContextExecutor, singular bool, maybeEvent interface{}, mods queries.Applicator) error {
	var slice []*Event
	var object *Event
	...
	query := NewQuery(
		qm.From(`event_days`),
		qm.WhereIn(`event_days.event_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if err != nil {
		return errors.Wrap(err, "failed to eager load event_days")
	}

	var resultSlice []*EventDay
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice event_days")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on event_days")
	}
	if err = results.Err(); err != nil {
		return errors.Wrap(err, "error occurred during iteration of eager loaded relations for event_days")
	}
	...
	if singular {
		object.R.EventDays = resultSlice
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.EventID {
				local.R.EventDays = append(local.R.EventDays, foreign)
				if foreign.R == nil {
					foreign.R = &eventDayR{}
				}
...
// AddEventDays adds the given related objects to the existing relationships
// of the event, optionally inserting them as new records.
// Appends related to o.R.EventDays.
// Sets related.R.Event appropriately.
func (o *Event) AddEventDays(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*EventDay) error {
	var err error
	...
	if o.R == nil {
		...
		o.R.EventDays = append(o.R.EventDays, related...)
	}
