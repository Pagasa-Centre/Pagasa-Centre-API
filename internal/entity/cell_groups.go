...
var CellGroupWhere = struct {
	...
	ID:       whereHelperint{field: "\"cell_groups\".\"id\""},
	Name:     whereHelpernull_String{field: "\"cell_groups\".\"name\""},
	LeaderID: whereHelpernull_Int{field: "\"cell_groups\".\"leader_id\""},
}
...
func FindCellGroup(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*CellGroup, error) {
...
func CellGroupExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	var exists bool
