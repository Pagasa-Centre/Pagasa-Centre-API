...
var (
	userDBTypes = map[string]string{`ID`: `integer`, `FirstName`: `character varying`, `LastName`: `character varying`, `Email`: `character varying`, `HashedPassword`: `character varying`, `CreatedAt`: `timestamp without time zone`}
	_           = bytes.MinRead
)
